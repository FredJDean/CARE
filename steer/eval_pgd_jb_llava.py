...
def load_jailbreak(data_path, model_type='llava',attack_type="constrain_16", eval_type='val', seed=100):
    """
...
if __name__ == "__main__":
    ...
    data = load_jailbreak(
        data_path="/root/fujinhu/data/pgd_data/",
        attack_type="unconstrain",  # 可选: "constrain_16", "constrain_32", "constrain_64", "unconstrain"
    ...
    result_file = "./data/llava/results_steer_jail_harmbench.json"
    ...
    #     n_components_visual=128,
    #     n_components_text=128,
